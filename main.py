...
plt.figure(figsize=(7,4))
plt.title(r"Electron density $\Psi^{2}$")
plt.plot(x,density)
plt.show()


# verify
LUMO = np.genfromtxt('data/LUMOHeH+.txt')
HOMO = np.genfromtxt('data/HOMOHeH+.txt')
density = np.genfromtxt('data/densityHeH+.txt')
...
plt.figure(figsize=(7,4))
plt.title(r"Electron density $e\AA^3$ RHF/aug-cc-pVQZ")
